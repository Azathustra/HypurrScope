...
const checks = [
  ...
  ["Beginner mode default", page.includes('useState<UserMode>("beginner")') && page.includes("Beginner") && page.includes("Pro")],
  ["Simple watch cards", page.includes("What to watch now") && page.includes("Simple BTC / ETH / HYPE alerts first.") && page.includes("Create Telegram Alert") && page.includes("beginnerCard")],
  ["Beginner guide and pro gate", page.includes("How to read this") && page.includes("Show pro dashboard") && page.includes("Advanced dashboard")],
  ["Beginner Telegram modal", page.includes("TelegramBeginnerModal") && page.includes("Telegram username or chat id") && page.includes("Watch level")],
