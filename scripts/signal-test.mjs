...
const checks = [
  ...
  ["Signal history episode recording", page.includes("signalHistoryPayload") && page.includes("setSignalHistory") && page.includes("signal.finalScore >= 75") && page.includes("signal.flowScore === null")],
  ["Signal history clean UI", page.includes("Episodes tracked") && page.includes("Resolved") && page.includes("Pending") && page.includes("No resolved signals yet")],
