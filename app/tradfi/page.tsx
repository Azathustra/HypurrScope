  ...
  return (
    <div className="space-y-7">
      <div>
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-white lg:text-5xl">Top 100 TradFi live</h1>
        <p className="mt-3 max-w-3xl text-base leading-7 text-muted">
          Indices, ETF, actions tech, banques, energie et proxies crypto avec variations 24h, 7j, 30j et tendance.
        </p>
      </div>
      <div className="grid gap-4 md:grid-cols-3">
        <StatCard label="Univers suivi" value="Top 100" detail="Actions, ETF, proxies crypto" />
        <StatCard label="Frequence" value="Live" detail="Flux Yahoo Finance" tone="positive" />
