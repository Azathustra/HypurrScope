...
export function PublicNavbar() {
  ...
  const copy =
    locale === "en"
      ? { pricing: "Pricing", research: "Research", methodology: "Methodology", faq: "FAQ", login: "Login", member: "Become a member" }
      : { pricing: "Abonnements", research: "Recherche", methodology: "Methode", faq: "FAQ", login: "Login", member: "Devenir membre" };
